...
포팅돼 있습니다(아래 [macOS](#macos-실험적) 섹션). 실행해 두면 동작하고, 끄면 원래대로 돌아옵니다.
Windows판의 DNS 우회는 IPv4/IPv6 질의를 모두 처리하고, SNI/DPI 우회는 IPv4의
TCP/443·UDP/443 트래픽을 대상으로 합니다. (macOS판은 IPv4 전용)
